...
export const getNotifications = async (req, res, next) => {
  try {
    ...
    // apiResponse.paginated expects meta to be { page, limit, totalItems } and any extras.
    // Wait, let's verify if `apiResponse.paginated` allows passing extra meta fields.
    ...
    return apiResponse.paginated(res, items, meta, 'Notifications retrieved successfully');
  } catch (err) {
    next(err);
  }
};
